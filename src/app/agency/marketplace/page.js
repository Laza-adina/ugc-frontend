...
export default function MarketplacePage() {
  ...
  const [filters, setFilters] = useState({ niche: '', platform: '', level: '', location: '', isAvailable: false, minFollowers: '' });
      ...
      <Card style={{ marginBottom: 'var(--space-6)' }}>
        <div className={styles.filters}>
          ...
          <Input
            ...
            style={{ width: 120 }}
          />
          <label className={styles.checkboxItem} style={{ fontSize: 'var(--font-size-sm)', display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          {creators.map((creator) => (
            <Card key={creator.id}>
              <div className={styles.creatorHeader}>
                ...
                <div style={{ flex: 1 }}>
                  <div className={styles.username} style={{ cursor: 'pointer', color: 'var(--color-accent)' }} onClick={() => router.push(`/agency/marketplace/${creator.id}`)}>
                    {creator.username}
                  </div>
              ...
              <div className={styles.vettingRow}>
                ...
                <div className={styles.actions}>
                  <Button size="sm" variant="ghost" onClick={() => router.push(`/agency/marketplace/${creator.id}`)}>Voir</Button>
        ...
        >
          <div className={styles.inviteForm}>
            ...
            <Input
              ...
              onChange={(e) => setInviteForm({ ...inviteForm, fee: e.target.value })}
            />
          </div>
        </Modal>
      )}
